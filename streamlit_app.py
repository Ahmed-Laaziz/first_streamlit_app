...
# Allow the end user to add a fruit to the list def insert_row_snowflake (new_fruit):
...
if streamlit.button('Add a Fruit to the List'):
  my_cnx = snowflake.connector.connect(**streamlit.secrets["snowflake"]) back_from_function insert_row_snowflake(add_my_fruit) streamlit.text(back_from_function)
